...
class OptimizationReactiveCalculator(a: Int, b: Int) {

    val subjectCalc: Subject<OptimizationReactiveCalculator> = PublishSubject.create()
...
fun main(args: Array<String>) {
    ...
    val calculator: OptimizationReactiveCalculator = OptimizationReactiveCalculator(15, 10)
